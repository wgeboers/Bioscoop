...
namespace Bioscoop.Api.Migrations
{
    ...
    [Migration("20230314175206_ticketPopcornSpecial")]
    partial class ticketPopcornSpecial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bioscoop.Api.Entities.Show", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 14, 18, 52, 6, 494, DateTimeKind.Local).AddTicks(5136),
                            Type = "2D"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 14, 18, 52, 6, 494, DateTimeKind.Local).AddTicks(5183),
                            Type = "3D"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 14, 18, 52, 6, 494, DateTimeKind.Local).AddTicks(5192),
                            Type = "3D-HFR"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 14, 18, 52, 6, 494, DateTimeKind.Local).AddTicks(5200),
                            Type = "IMAX"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 14, 18, 52, 6, 494, DateTimeKind.Local).AddTicks(5207),
                            Type = "2D"
                        });
                });
