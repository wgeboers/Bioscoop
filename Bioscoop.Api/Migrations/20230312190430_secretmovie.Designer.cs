...
namespace Bioscoop.Api.Migrations
{
    ...
    [Migration("20230312190430_secretmovie")]
            ...
            modelBuilder.Entity("Bioscoop.Api.Entities.Show", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 12, 20, 4, 30, 673, DateTimeKind.Local).AddTicks(4707),
                            Type = "2D"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 12, 20, 4, 30, 673, DateTimeKind.Local).AddTicks(4761),
                            Type = "3D"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 12, 20, 4, 30, 673, DateTimeKind.Local).AddTicks(4772),
                            Type = "3D-HFR"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 12, 20, 4, 30, 673, DateTimeKind.Local).AddTicks(4782),
                            Type = "IMAX"
                        },
                        new
                        {
                            ...
                            MovieId = 3,
                            RoomId = 2,
                            StartDateTime = new DateTime(2023, 3, 12, 20, 4, 30, 673, DateTimeKind.Local).AddTicks(4793),
                            Type = "2D"
                        });
                });
