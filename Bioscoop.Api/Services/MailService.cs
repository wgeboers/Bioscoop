...
namespace Bioscoop.Api.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task<bool> SendWithAttachmentByteAsync(MailDataWithAttachmentByte mailData, CancellationToken ct)
        {
            try
            {
                // Initialize a new instance of the MimeKit.MimeMessage class
                ...
                body.Attachments.Add("Ticket.pdf", mailData.Attachment, ContentType.Parse("application/pdf"));
